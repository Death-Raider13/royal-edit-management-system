  ...
  return (
    <div className="min-h-screen bg-[#0b0c0e] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -right-40 w-[600px] h-[600px] rounded-full bg-amber-700/5 blur-[120px]" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm mt-1">Sign in to your management portal</p>
        </div>
